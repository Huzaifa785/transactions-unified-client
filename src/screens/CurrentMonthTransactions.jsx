...
import CurrentMonthTransactions from "../components/Dashboard/Transactions";
...
function CurrentMonthTransactionsContent() {
            ...
            <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8} lg={9}>
                  ...
                  >
                    <Chart timeLimit="Current Month's" data={data} />
                  </Paper>
                </Grid>
...
export default function CurrentMonthTransactionsScreen() {
  return <CurrentMonthTransactionsContent />;
}
