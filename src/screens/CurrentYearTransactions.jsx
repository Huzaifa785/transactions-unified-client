...
import CurrentYearTransactions from "../components/Dashboard/Transactions";
...
function CurrentYearTransactionsContent() {
  const [open, setOpen] = React.useState(true);
  const toggleDrawer = () => {
    setOpen(!open);
  };

  const [yearSpending, setYearSpending] = useState(0);
            ...
            <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={8} lg={9}>
                  ...
                  >
                    <Chart timeLimit="Current Year's" data={data} />
                  </Paper>
                </Grid>
...
export default function CurrentYearTransactionsScreen() {
  return <CurrentYearTransactionsContent />;
}
